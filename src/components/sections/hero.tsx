    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="section-container relative z-10 pt-32 pb-20">
        <motion.div variants={container} initial="hidden" animate="show" className="max-w-4xl">
          <motion.div variants={item} className="mb-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-cyber-600/20 bg-cyber-600/5 px-4 py-1.5">
              <span className="relative flex h-2 w-2">
                ...
                <span className="relative inline-flex h-2 w-2 rounded-full bg-cyber-500" />
              </span>
          ...
          <motion.p variants={item} className="mb-10 max-w-2xl text-lg sm:text-xl text-obsidian-400 leading-relaxed">
            ...
            building enterprise-grade applications and defending digital infrastructure across Africa.
          </motion.p>
